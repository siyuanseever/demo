...
CHARACTERS = {
    "sensen_deer": CharacterProfile(
        ...
        status_avatar_path="/static/mianmian-sheep-status.webp",
        showcase_avatar_path="/static/mianmian-sheep-showcase.png",
        bubble_color="#fff4dc",
        prompt=(
    ...
    "gugu_bear": CharacterProfile(
        ...
        status_avatar_path="/static/shishi-turtle-status.webp",
        showcase_avatar_path="/static/shishi-turtle-showcase.png",
        bubble_color="#e8f3de",
        prompt=(
            "你叫石石龟，是一只慢慢的、稳稳的小乌龟。"
    ...
    "huahua_fox": CharacterProfile(
        ...
        status_avatar_path="/static/momo-crow-status.webp",
        showcase_avatar_path="/static/momo-crow-showcase.png",
        bubble_color="#eceaf6",
        prompt=(
    ...
    "youyou_rabbit": CharacterProfile(
        ...
        status_avatar_path="/static/youyou-rabbit-status.webp",
        showcase_avatar_path="/static/youyou-rabbit-showcase.png",
        bubble_color="#fde7ef",
        prompt=(
    ...
    "shanshan_butterfly": CharacterProfile(
        ...
        status_avatar_path="/static/shanshan-butterfly-showcase.png",
        showcase_avatar_path="/static/shanshan-butterfly-showcase.png",
        bubble_color="#e5f5ff",
        prompt=(
    ...
    "gangan_tiger": CharacterProfile(
        ...
        status_avatar_path="/static/gangan-tiger-status.webp",
        showcase_avatar_path="/static/gangan-tiger-showcase.png",
        bubble_color="#ffe3c7",
        prompt=(

                ...
                content = json.dumps(
                    {
                        "updates": [
                            ...
                            },
                            {
                                ...
                                "evidence": [],
                                "support_strategy": "",
                                "reason": "fake 模式：本次没有足够的边界证据。",
                            },
                            {
                                "action": "no_change",
                                "domain": "trauma_pattern",
                                "stage": "尚未形成清晰阶段",
                                "summary": "",
                                "intensity": 5,
                                "trend": "unknown",
